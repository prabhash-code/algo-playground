...
class Solution {
    ...
    public static LinkedList.Node insertNodeAtHead(LinkedList.Node head, List<Integer> data) {
    ...
    public static void main(String[] args) {
        try {
            ...
            LinkedList.Node node = Solution.insertNodeAtHead(head, arr.subList(1, arrCount));
